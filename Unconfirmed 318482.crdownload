...
function renderProducts(category) {
    ...
    filteredProducts.forEach((product, index) => {
        ...
        // FIXED: Added width and height attributes to prevent CLS
...
function initializePWA() {
    ...
    window.addEventListener('appinstalled', () => {
        ...
        // Show notification prompt after app install
        setTimeout(() => {
...
if (notificationToggle) {
    notificationToggle.addEventListener('click', () => {
        ...
        if (Notification.permission === 'granted') {
            // Already enabled - show a test notification
            sendNotification(
            ...
            // Show message about how to re-enable
...
function showNotificationPrompt() {
    console.log('showNotificationPrompt called');
    ...
    if (localStorage.getItem('notificationPromptShown')) {
        ...
        // Clear this for testing - remove in production
        localStorage.removeItem('notificationPromptShown');
    }
    
    console.log('Showing notification prompt popup');
